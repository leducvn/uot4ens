...
experiment = 'Kyushu02km'; expdesc='LETKF1000'; start = 6*60; end = 15*60
...
input_dir = root_dir
input_file = input_dir+'/'+area+'%2.2d'%iexp+'mean_'+'%2.2d'%(start/60)+'%2.2d'%(end/60)+'.nc'
...
print('Domain: ', slon0, elon0, slat0, elat0)
...
for k in range(3):
   if k == 0: tmp[jmin:jmax+1,imin:imax+1] = c[:,:]
   elif k == 1: tmp[jmin:jmax+1,imin:imax+1] = b[:,:]
