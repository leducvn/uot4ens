...
iexp = 2
analysis_date = '202007030900'
experiment = 'Kyushu02km'; nmember = 1001; start = 1*60; end = 24*60; period = 1*60
#experiment = 'Fugaku05km'; nmember = 21; start = 1*60; end = 27*60; period = 1*60
fortran_file = 'fort'
format = 'png'; density = '-density 100'
description = 'Experiment: LETKF1000; Ensemble members: '+str(nmember-1)
...
#output_file = output_dir+'/Figure06c.'+format
#plot_histogram(hour, histogram, cumulative=False, figtype='c')
#shutil.move('graph.'+format, output_file)
output_file = output_dir+'/Figure06c.'+format
plot_histogram(hour, cumulative, cumulative=True, figtype='c')
shutil.move('graph.'+format, output_file)
