...
def plot_histogram(hour, a, e, b, cumulative=False, figtype=''):
   ...
   lgd_file.write('S 0.13i T 0.13i red 0.3p 0.25i GHK barycenter\n')
...
output_file = output_dir+'/Figure04.'+format
plot_histogram(time, 500*a, 500*e, 500*b[1], cumulative=False)
